 ...
 * @version 1.0
 */
public class JBossLogFrameworkF extends LogFrameworkDefaults {
	JBossLogFrameworkF() {
		super("jboss-logging-printf");
		...
		setLogMessageFormatType(MessageFormatType.printf);

		for (LogLevel logLevel : LogLevel.values())
			getLogMethod().put(logLevel, logLevel.name() + "f");
