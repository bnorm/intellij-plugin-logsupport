...
import net.sf.logsupport.ui.RemoveLogIdsDialog;
 ...
 * @version 1.0
 */
public class RemoveLogIds extends AbstractLogIdAction {

	@Override
	protected AbstractProcessingDialog createDialog(Project project) {
		return new RemoveLogIdsDialog(project, getSelection(project));
	}
}
