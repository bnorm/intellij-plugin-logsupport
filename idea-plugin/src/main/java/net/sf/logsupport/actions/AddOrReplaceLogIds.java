...
import net.sf.logsupport.ui.AddOrReplaceLogIdsDialog;
 ...
 * @version 1.0
 */
public class AddOrReplaceLogIds extends AbstractLogIdAction {

	@Override
	protected AbstractProcessingDialog createDialog(Project project) {
		return new AddOrReplaceLogIdsDialog(project, getSelection(project));
	}
}
