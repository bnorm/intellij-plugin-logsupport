...
import net.sf.logsupport.ui.GenerateLogReviewDialog;
 ...
 * @version 1.0
 */
public class GenerateLogReview extends AbstractLogReviewAction {

	@Override
	protected AbstractProcessingDialog createDialog(Project project) {
		return new GenerateLogReviewDialog(project, getSelection(project));
	}
}
